...
- [ ] Remaining: pre-330 Byzantion and deep-time city-states (legitimately pre-imperial); a few mid-timeline gaps on cities whose modern tag jumps over centuries (e.g. Kerch null 969→2014).
```
