...
- [x] Complete modern layer: **every still-extant city is tagged to its present-day sovereign in 2020** (all 195 cities carrying a 2020 population resolve; ruins like Babylon/Persepolis/Veii correctly stay independent). Added the 14 missing national capitals (Accra, Bamako, Lagos, Nairobi, Dar es Salaam, Addis Ababa, Ottawa, Kabul, Islamabad, Beirut, Bangkok, Jakarta, Kuala Lumpur, Ramallah) plus tags for Athens→Greece, Mogadishu→Somalia, and decolonization/handover events for the rest. Now 315 cities.
- [x] Comprehensive modern-capital & metro pass (6 regional tranches). Sovereigns represented at 2020 jumped **61 → 150**. Added the colonial-power home capitals and the **Belgian colonial empire** (Brussels → Congo Free State → Belgian Congo → DR Congo via Kinshasa/Lubumbashi); the Nordics, Benelux, Balkans/Baltics, all of Latin America + Caribbean, South/SE/Central Asia + the Gulf, ~30 Sub-Saharan capitals, and Oceania (new regions: Northern Europe, Oceania). Fixed the Manila→US mistag (now Philippines). Now 413 cities; every one of the 293 cities carrying a 2020 population resolves to its present-day state.
- [ ] Remaining: the long tail of micro-states / small island nations (~45 of ~195 sovereigns — most Pacific & Caribbean micro-states, a few small African states); pre-330 Byzantion and deep-time city-states; a few mid-timeline gaps where a modern tag jumps over centuries (e.g. Kerch null 969→2014).
```
